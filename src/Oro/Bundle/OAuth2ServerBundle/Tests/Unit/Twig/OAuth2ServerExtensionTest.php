...
use Oro\Bundle\OAuth2ServerBundle\Twig\OAuth2ServerExtension;
...
class OAuth2ServerExtensionTest extends TestCase
{
    ...
    private OAuth2ServerExtension $extension;
    ...
    protected function setUp(): void
    {
        ...
        $this->extension = new OAuth2ServerExtension($this->apiDocViewProvider);
    }
